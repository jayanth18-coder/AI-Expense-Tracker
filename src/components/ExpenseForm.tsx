...
export function ExpenseForm({ open, onOpenChange, onSuccess }) {
  ...
  useEffect(() => {
    ...
    async function fetchUserCategories() {
      ...
      // Fetch all global + user categories, case-insensitive matching for 'expense' in type
      ...
      if (isMounted) {
        ...
        console.log("Fetched categories, filtered for expense:", filtered);
      }
    }
    if (open) {
      fetchUserCategories();
